...
SO100_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        # Position the robot so it can grab the wall at x=0.8
        # Robot is at (0.5, 0.0, 1.5) to be near the wall's center height
        pos=(0.5, 0.0, 1.5),
    ),
...
class BrachiationSceneCfg(SceneCfg):
    ...
    wall = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(0.8, 0.0, 1.0)),
    )
